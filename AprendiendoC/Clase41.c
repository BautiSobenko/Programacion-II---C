/*Hacer un programa en C. Para guardar direcciones de correo que muestre un menu
...
void crear(){
	char direccion[] = "E:\\archivosC cursoUdemy\\Ejercicios Propuestos y Resueltos en C\\Ejercicios en C\\Nivel 10 - Entradas y Salidas por Archivos\\directorio.txt";
	char rpt;
